...
!function (a, b) {
                ...
                var h = this,
                  ...
                  j = function () {
                    ...
                    if (!(b < f)) {
                      ...
                      j = a && ("object" == typeof a || "function" == typeof a) && a.then, r.isFunction(j) ? e ? j.call(a, g(f, c, M, e), g(f, c, N, e)) : (f++, j.call(a, g(f, c, M, e), g(f, c, N, e), g(f, c, M, c.notifyWith))) : (d !== M && (h = void 0, i = [
                        a,
                      ]), (e || c.resolveWith)(h, i))
                    }
                  },
                  k = e ? j : function () {
                    try {
                      ...
                      r.Deferred.exceptionHook && r.Deferred.exceptionHook(a, k.stackTrace), b + 1 >= f && (d !== N && (h = void 0, i = [
                        a,
                      ]), c.rejectWith(h, i))
                    }
                  };
  ...
  function ma(a, b) {
    var c;
    return c = "undefined" != typeof a.getElementsByTagName ? a.getElementsByTagName(b || "*") : "undefined" != typeof a.querySelectorAll ? a.querySelectorAll(b || "*") : [], void 0 === b || b && r.nodeName(a, b) ? r.merge([
      a,
    ], c) : c
  }
  function na(a, b) {
      ...
      if (i && j.nodeType && !("click" === a.type && a.button >= 1)) {
        for (;j !== this; j = j.parentNode || this) {
          if (1 === j.nodeType && ("click" !== a.type || j.disabled !== !0)) {
            for (f = [], g = {}, c = 0; c < i; c++) {
              d = b[c], e = d.selector + " ", void 0 === g[e] && (g[e] = d.needsContext ? r(e, this).index(j) > -1 : r.find(e, this, null, [
                j,
              ]).length), g[e] && f.push(d);
            }
    ...
    r.cssHooks[a + b] = {
      expand: function (c) {
        for (var d = 0, e = {}, f = "string" == typeof c ? c.split(" ") : [
          c,
        ]; d < 4; d++)e[a + ba[d] + b] = f[d] || f[d - 2] || f[0];
        return e
      },
  ...
  function fb(a, b, c) {
    ...
    if (i = !r.isEmptyObject(b), i || !r.isEmptyObject(n)) {
      l && 1 === a.nodeType && (c.overflow = [
        ...
        o.overflowX,
        o.overflowY,
      ], j = q && q.display, null == j && (j = V.get(a, "display")), k = r.css(a, "display"), "none" === k && (j ? k = j : (ha([
          a,
        ], !0), j = a.style.display || j, k = r.css(a, "display"), ha([
            a,
...
u[b] = [
      ...
      if (s.promise(y), o.url = ((b || o.url || qb.href) + "").replace(Eb, qb.protocol + "//"), o.type = c.method || c.type || o.method || o.type, o.dataTypes = (o.dataType || "*").toLowerCase().match(K) || [
        "",
      ], null == o.crossDomain) {
        j = d.createElement("a");
        try {
